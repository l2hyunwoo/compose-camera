...
kotlin {
    androidLibrary {
        namespace = "io.github.l2hyunwoo.camera.plugin.mlkit.text"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "camera-plugin-mlkit-text", version.toString())

    pom {
        name = "Compose Camera MLKit Text Plugin"
        description = "Text recognition plugin for Compose Camera library using Google ML Kit"
        inceptionYear = "2025"
